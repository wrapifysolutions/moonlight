...
class OnboardingDreamCity extends ConsumerStatefulWidget {
  const OnboardingDreamCity({super.key});

  @override
  ConsumerState<OnboardingDreamCity> createState() =>
      _OnboardingDreamCityState();
}

class _OnboardingDreamCityState extends ConsumerState<OnboardingDreamCity> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              OnboardingTitle(
                primaryText: l10n.dreamCityTitlePrimary,
                accentText: l10n.dreamCityTitleAccent,
              ),

              SizedBox(height: AppSizes.height(4)),

              CustomTextField(
                hintText: l10n.dreamCityHint,
                controller: _controller,
                onChanged: (val) => notifier.setDreamCity(val),
                maxLines: 8,
                minLines: 8,
              ...
              Center(
                child: CustomElevatedButton(
                  ...
                  onPressed: () {
                    notifier.nextStep();
                    context.goToOnboardingDreamHome();
                  },
                ),
              ),
