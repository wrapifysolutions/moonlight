...
class OnboardingPartnerKind extends ConsumerStatefulWidget {
  const OnboardingPartnerKind({super.key});

  @override
  ConsumerState<OnboardingPartnerKind> createState() =>
      _OnboardingPartnerKindState();
}

class _OnboardingPartnerKindState extends ConsumerState<OnboardingPartnerKind> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              OnboardingTitle(
                primaryText: l10n.partnerKindTitlePrimary,
                accentText: l10n.partnerKindTitleAccent,
              ),

              SizedBox(height: AppSizes.height(4)),

              CustomTextField(
                hintText: l10n.partnerKindHint,
                controller: _controller,
                onChanged: (val) => notifier.setKindOfPartner(val),
                maxLines: 8,
                minLines: 8,
              ...
              Center(
                child: CustomElevatedButton(
                  ...
                  onPressed: () {
                    notifier.nextStep();
                    context.goToOnboardingPersonName();
                  },
                ),
              ),
