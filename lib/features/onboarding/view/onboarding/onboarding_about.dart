...
class OnboardingAbout extends ConsumerStatefulWidget {
  const OnboardingAbout({super.key});

  @override
  ConsumerState<OnboardingAbout> createState() => _OnboardingAboutState();
}

class _OnboardingAboutState extends ConsumerState<OnboardingAbout> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  OnboardingTitle(
                    primaryText: l10n.aboutTitlePrimary,
                    accentText: l10n.aboutTitleAccent,
                  ),

                  SizedBox(height: AppSizes.height(4)),

                  // Glassmorphism multiline text area
                  CustomTextField(
                    hintText: l10n.aboutHint,
                    controller: _controller,
                    onChanged: (val) => notifier.setAboutYourself(val),
                    maxLines: 8,
                    minLines: 8,
