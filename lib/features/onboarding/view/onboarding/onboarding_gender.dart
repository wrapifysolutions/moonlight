...
class OnboardingGender extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final genders = OnboardingL10n.genderOptions(l10n);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              OnboardingTitle(
                primaryText: l10n.genderTitlePrimary,
                accentText: l10n.genderTitleAccent,
              ),
              ...
              OnboardingOptionsList(
                ...
                itemBuilder: (context, index) {
                  ...
                  final isSelected = state.gender == item['label'];

                  return OnboardingCard(
                    label: item['label'] as String,
                    isSelected: isSelected,
                    onTap: () => notifier.setGender(item['label'] as String),
                    leadingIcon: Icon(
              ...
              Center(
                child: CustomElevatedButton(
                  ...
                  onPressed: () {
                    notifier.nextStep();
                    context.goToOnboardingOrientation();
                  },
                ),
              ),
