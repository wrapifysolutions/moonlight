...
class OnboardingWorkFeel extends ConsumerWidget {
  const OnboardingWorkFeel({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final options = OnboardingL10n.workFeelOptions(l10n);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              OnboardingTitle(
                primaryText: l10n.workFeelTitlePrimary,
                accentText: l10n.workFeelTitleAccent,
              ),
              ...
              OnboardingOptionsList(
                ...
                itemBuilder: (context, index) {
                  ...
                  final isSelected = state.workFeel == item['label'];

                  return OnboardingCard(
                    label: item['label'] as String,
                    isSelected: isSelected,
                    leadingIconShape: LeadingIconShape.circle,
                    onTap: () => notifier.setWorkFeel(item['label'] as String),
                    leadingIcon: Icon(
              ...
              Center(
                child: CustomElevatedButton(
                  ...
                  onPressed: () {
                    notifier.nextStep();
                    context.goToOnboardingBiggestLesson();
                  },
                ),
              ),
