...
class OnboardingHoldingBack extends ConsumerStatefulWidget {
  const OnboardingHoldingBack({super.key});

  @override
  ConsumerState<OnboardingHoldingBack> createState() =>
      _OnboardingHoldingBackState();
}

class _OnboardingHoldingBackState extends ConsumerState<OnboardingHoldingBack> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              OnboardingTitle(
                primaryText: l10n.holdingBackTitlePrimary,
                accentText: l10n.holdingBackTitleAccent,
              ),

              SizedBox(height: AppSizes.height(4)),

              CustomTextField(
                hintText: l10n.holdingBackHint,
                controller: _controller,
                onChanged: (val) => notifier.setHoldingYouBack(val),
                maxLines: 8,
                minLines: 8,
              ...
              Center(
                child: CustomElevatedButton(
                  ...
                  onPressed: () {
                    notifier.nextStep();
                    context.goToOnboardingDreamCity();
                  },
                ),
              ),
