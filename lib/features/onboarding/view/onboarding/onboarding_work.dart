...
class OnboardingWork extends ConsumerStatefulWidget {
  const OnboardingWork({super.key});

  @override
  ConsumerState<OnboardingWork> createState() => _OnboardingWorkState();
}

class _OnboardingWorkState extends ConsumerState<OnboardingWork> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  OnboardingTitle(
                    primaryText: l10n.workTitlePrimary,
                    accentText: l10n.workTitleAccent,
                  ),

                  SizedBox(height: AppSizes.height(4)),

                  CustomTextField(
                    hintText: l10n.workHint,
                    controller: _controller,
                    onChanged: (val) => notifier.setWork(val),
                    maxLines: 8,
                    minLines: 8,
                  ...
                  Center(
                    child: CustomElevatedButton(
                      ...
                      onPressed: () {
                        notifier.nextStep();
                        context.goToOnboardingWorkFeel();
                      },
                    ),
                  ),
