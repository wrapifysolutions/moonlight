...
class OnboardingDreamHome extends ConsumerWidget {
  const OnboardingDreamHome({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final options = OnboardingL10n.dreamHomeOptions(l10n);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              OnboardingTitle(
                primaryText: l10n.dreamHomeTitlePrimary,
                accentText: l10n.dreamHomeTitleAccent,
              ),
              ...
              OnboardingOptionsList(
                ...
                itemBuilder: (context, index) {
                  ...
                  final isSelected = state.dreamHome == option;

                  return OnboardingCard(
                    label: option,
                    isSelected: isSelected,
                    onTap: () => notifier.setDreamHome(option),
                  );
                },
              ),
              ...
              Center(
                child: CustomElevatedButton(
                  ...
                  onPressed: () {
                    notifier.nextStep();
                    context.goToOnboardingManifestingPerson();
                  },
                ),
              ),
