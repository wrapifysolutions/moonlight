...
class OnboardingStruggling extends ConsumerStatefulWidget {
  const OnboardingStruggling({super.key});

  @override
  ConsumerState<OnboardingStruggling> createState() => _OnboardingStrugglingState();
}

class _OnboardingStrugglingState extends ConsumerState<OnboardingStruggling> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              OnboardingTitle(
                primaryText: l10n.strugglingTitlePrimary,
                accentText: l10n.strugglingTitleAccent,
              ),

              SizedBox(height: AppSizes.height(4)),

              CustomTextField(
                hintText: l10n.strugglingHint,
                controller: _controller,
                onChanged: (val) => notifier.setStrugglingWith(val),
                maxLines: 8,
                minLines: 8,
              ...
              Center(
                child: CustomElevatedButton(
                  ...
                  onPressed: () {
                    notifier.nextStep();
                    context.goToOnboardingLoveLife();
                  },
                ),
              ),
