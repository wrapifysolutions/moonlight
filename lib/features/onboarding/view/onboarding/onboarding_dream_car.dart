...
class OnboardingDreamCar extends ConsumerStatefulWidget {
  const OnboardingDreamCar({super.key});

  @override
  ConsumerState<OnboardingDreamCar> createState() =>
      _OnboardingDreamCarState();
}

class _OnboardingDreamCarState extends ConsumerState<OnboardingDreamCar> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              OnboardingTitle(
                primaryText: l10n.dreamCarTitlePrimary,
                accentText: l10n.dreamCarTitleAccent,
              ),

              SizedBox(height: AppSizes.height(4)),

              CustomTextField(
                hintText: l10n.dreamCarHint,
                controller: _controller,
                onChanged: (val) => notifier.setDreamCar(val),
                maxLines: 8,
                minLines: 8,
