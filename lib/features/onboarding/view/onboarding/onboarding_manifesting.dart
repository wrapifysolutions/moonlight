...
class OnboardingManifesting extends ConsumerStatefulWidget {
  const OnboardingManifesting({super.key});

  @override
  ConsumerState<OnboardingManifesting> createState() => _OnboardingManifestingState();
}

class _OnboardingManifestingState extends ConsumerState<OnboardingManifesting> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              OnboardingTitle(
                primaryText: l10n.manifestingTitlePrimary,
                accentText: l10n.manifestingTitleAccent,
              ),

              SizedBox(height: AppSizes.height(4)),

              CustomTextField(
                hintText: l10n.manifestingHint,
                controller: _controller,
                onChanged: (val) => notifier.setManifestingDescription(val),
                maxLines: 8,
                minLines: 8,
              ...
              Center(
                child: CustomElevatedButton(
                  ...
                  onPressed: () {
                    notifier.nextStep();
                    context.goToOnboardingHoldingBack();
                  },
                ),
              ),
