...
class OnboardingOrientation extends ConsumerWidget {
  const OnboardingOrientation({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final options = OnboardingL10n.sexualOrientationOptions(l10n);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              OnboardingTitle(
                primaryText: l10n.orientationTitlePrimary,
                accentText: l10n.orientationTitleAccent,
              ),
              ...
              OnboardingOptionsList(
                ...
                itemBuilder: (context, index) {
                  ...
                  final isSelected = state.sexualOrientation == option;

                  return OnboardingCard(
                    label: option,
                    isSelected: isSelected,
                    onTap: () => notifier.setSexualOrientation(option),
                  );
                },
              ),
              ...
              Center(
                child: CustomElevatedButton(
                  ...
                  onPressed: () {
                    notifier.nextStep();
                    context.goToOnboardingChildren();
                  },
                ),
              ),
