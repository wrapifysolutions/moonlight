...
import 'package:moonlight/shared/widgets/picker/date_picker.dart';
...
class OnboardingDob extends ConsumerWidget {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  OnboardingTitle(
                    primaryText: l10n.dobTitlePrimary,
                    accentText: l10n.dobTitleAccent,
                  ),

                  SizedBox(height: AppSizes.height(4)),

                  const DateDrumPicker(),
