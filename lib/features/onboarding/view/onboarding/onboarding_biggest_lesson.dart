...
class OnboardingBiggestLesson extends ConsumerStatefulWidget {
  const OnboardingBiggestLesson({super.key});

  @override
  ConsumerState<OnboardingBiggestLesson> createState() => _OnboardingBiggestLessonState();
}

class _OnboardingBiggestLessonState extends ConsumerState<OnboardingBiggestLesson> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              OnboardingTitle(
                primaryText: l10n.biggestLessonTitlePrimary,
                accentText: l10n.biggestLessonTitleAccent,
              ),

              SizedBox(height: AppSizes.height(4)),

              CustomTextField(
                hintText: l10n.biggestLessonHint,
                controller: _controller,
                onChanged: (val) => notifier.setBiggestLesson(val),
                maxLines: 8,
                minLines: 8,
              ...
              Center(
                child: CustomElevatedButton(
                  ...
                  onPressed: () {
                    notifier.nextStep();
                    context.goToOnboardingStruggling();
                  },
                ),
              ),
